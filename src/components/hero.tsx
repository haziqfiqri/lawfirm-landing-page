  ...
  return (
    <React.Fragment>
      <section className="relative flex min-h-96 w-full overflow-hidden">
        ...
        {/* Content */}
        <div className="relative flex flex-col lg:flex-row justify-center items-center w-full text-white z-10 px-4 container sm:mx-auto max-w-7xl">
          <div className="flex flex-col gap-4 w-full lg:w-1/2">
            <h1 className="font-tinos-regular font-normal text-6xl text-white">
              Let us assist on your legal matters
            </h1>
            <p className="font-instrument-sans-regular font-normal text-xl max-w-2xl mb-5">
